...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #blackhatcoinTEST\r");
            Send(hSocket, "WHO #blackhatcoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #blackhatcoin\n");
            // randomly join #blackhatcoin00-#blackhatcoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #blackhatcoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #blackhatcoin%02d\r", channel_number).c_str());
        };

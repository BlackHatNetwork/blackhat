...
int nAnonymizeBlackHatAmount = 500;
...
{
    boost::filesystem::path pathConfigFile(GetArg("-conf", "blackhat.conf"));
...
{
    boost::filesystem::path pathPidFile(GetArg("-pid", "blackhatd.pid"));

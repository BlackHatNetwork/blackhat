BlackHat Core version 0.9.4 is now available from:

  https://blackhat.org/bin/0.9.4/
...
this update is incompatible with the BlackHat system and could lead to consensus
forks.

BlackHat Core released binaries from https://blackhat.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~blackhat/+archive/ubuntu/blackhat
- A third-party or self-compiled BlackHat Core

upgrade to BlackHat Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.

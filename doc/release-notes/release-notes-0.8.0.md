BlackHat-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/blackhat/files/BlackHat/blackhat-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the BlackHat
...
New/changed settings (command-line or blackhat.conf file)
--------------------------------------------------------

BlackHat version 0.5.4 is now available for download at:
http://sourceforge.net/projects/blackhat/files/BlackHat/blackhat-0.5.4/
...
http://gitorious.org/blackhat/blackhatd-stable/archive-tarball/v0.5.4#.tar.gz
...
Fix BlackHat-Qt notifications under Growl 1.3.
Increase required age of BlackHat-Qt's "not up to date" status from 30 to 90 minutes.
...
Remove wxBlackHat properly when installing BlackHat-Qt over it. (Windows)

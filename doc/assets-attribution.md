The following is a list of assets used in the blackhat source and their proper attribution.
...
* License: MIT
* Site: [https://blackhattalk.org/index.php?topic=15276.0](https://blackhattalk.org/index.php?topic=15276.0)
...
### Info
* Designer: Jonas Schnelli (based on the original blackhat logo from Bitboy)
* License: MIT

### Assets Used
	src/qt/res/icons/blackhat.icns, src/qt/res/src/blackhat.svg,
	src/qt/res/src/blackhat.ico, src/qt/res/src/blackhat.png,
	src/qt/res/src/blackhat_testnet.png, docs/blackhat_logo_doxygen.png,

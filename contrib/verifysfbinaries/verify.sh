...
###   This script attempts to download the signature file SHA256SUMS.asc from blackhat.org
...
WORKINGDIR="/tmp/blackhat"
TMPFILE="hashes.tmp"

#this URL is used if a version number is not specified as an argument to the script
SIGNATUREFILE="https://blackhat.org/bin/0.9.2.1/SHA256SUMS.asc"

SIGNATUREFILENAME="SHA256SUMS.asc"
RCSUBDIR="test/"
BASEDIR="https://blackhat.org/bin/"
VERSIONPREFIX="blackhat-"
RCVERSIONSTRING="rc"
...
if [ -n "$1" ]; then
   #let's also check if the version number includes the prefix 'blackhat-',
...
if [ $? -ne 0 ]; then
   ...
   echo "[blackhat-]<version>-[rc[0-9]] (example: blackhat-0.9.2-rc1)"
   echo "wget output:"

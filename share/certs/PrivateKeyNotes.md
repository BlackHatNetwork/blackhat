...
unlocked to sign the BlackHat-Qt.app bundle.
...
allowing somebody to distribute a BlackHat-Qt.app or blackhat-qt-setup.exe with a valid
...
that the blackhat-qt.exe file inside the installer had not been tampered with.
